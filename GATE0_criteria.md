...
project had itself measured the spread (Paris 4 IQR 134.4-259.2 um in
the atlas v2 table; per-point tolerance 3.4-37.5 vox on the mesh arm)
and built the A2.2 rule from his earlier critique precisely so that no
score depends on a spacing constant. He is right about the wording.
The README headline is reframed: the claim is the agreement between
